...
export default function ThemeSwitcher() {
  ...
  return (
    <button className={`theme_switcher flex items-center relative h-auto w-auto p-1 rounded-full dark:text-white bg-slate-100 dark:bg-black text-xs`}>
      <div className={`theme_switcher-plug absolute top-1 h-5 w-5 rounded-full bg-white dark:bg-slate-800 transition-all ${plugPosition}`}></div>
